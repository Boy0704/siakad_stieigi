...
class absensi extends MY_Controller{
    ...
    function load_mahasiswa()
    {
        ...
        $sql="  SELECT sm.nim,sm.nama,kh.mutu,kh.khs_id,kh.tugas,kh.kehadiran,kh.grade
                ...
                WHERE kh.krs_id=ak.krs_id and sm.nim=ak.nim and ak.jadwal_id='$jadwal_id' and jk.jadwal_id=ak.jadwal_id and jk.tahun_akademik_id='$thn' and sm.semester_aktif !=0";
        echo " <table class='table table-bordered'>
              <tr class='alert-info'><th colspan=2>MATAKULIAH</th></tr>
               ...
               <tr class='alert-info'><th colspan=6>DATA MAHASISWA</th></tr>
               <tr class=''><th>No</th><th>NIM</th><th>NAMA MAHASISWA</th><th width=120>Kehadiran</th></tr>";
        ...
        foreach ($data as $r)
        {
            ...
            echo "<tr>
                ...
                $absensi=  $this->db->get_where('student_absen_detail',array('nim'=>$r->nim,'absen_id'=>getField('student_absen', 'absen_id', 'tanggal', $tanggal), 'absen_id'=>getField('student_absen', 'absen_id', 'jadwal_id', $jadwal_id) ));
