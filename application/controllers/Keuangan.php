...
class keuangan extends MY_Controller
{
    ...
    function tampilkandata($konsentrasi,$tahun_akademik)
    {
        // fires else
            ...
            echo"
             ...
             <tr>
                <td></td>
                <td><span class='label label-success'>01 = Harus Dibayar</span>
                <span class='label label-warning'>02 = Telah Dibayar</span>
                <span class='label label-info'>03 = Sisa</span></td>
            </tr>
            </table>
            <hr>
            <table class='table table-bordered'>
            ...
            foreach ($jenis_bayar->result() as $j)
            {
                echo "<th><span class='label label-success' style='font-size:12px;'>01</span></th>
                    <th><span class='label label-warning' style='font-size:12px;'>02</span></th>
                    <th><span class='label label-info' style='font-size:12px;'>03</span></th>";
            }
            echo"</tr>";
            $no=1;
            ...
            {
                // zebra
                $bgcolor=$no % 2!=0?'class="warning"':'class="danger"';
                // end zebra
            ...
            echo"<table class='table table-bordered'>
                <tr class='alert-info'>
                <th colspan=".($smt_aktif+4).">PEMBAYARAN BPP | BIAYA BPP PERSEMESTER = RP. ". rp((int) $spp_bayar) ."</th>
                </tr>
                <tr>
                <th width='10'>No</th>
                <th width='60'>NIM</th>
    ...
    function tunggakan_mhs()
    {
            $id=$this->session->userdata('keterangan');
            $nim_session=getField('student_mahasiswa', 'nim', 'mahasiswa_id', $id);
            ...
            $data['title']=  $this->title;
            $this->template->load('template', 'keuangan/bayar/mahasiswa_view',$data);
    }
