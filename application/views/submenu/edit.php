...
$level=array(1=>'Admin',2=>'Pihak Jurusan',3=>'Pegawai', 4=>'Mahasiswa');
...
<table class="table table-bordered">
    ...
    <td width="150">Mainmenu</td><td>
        <?php echo editcombo('mainmenu','mainmenu','col-sm-3','nama_mainmenu','id_mainmenu',array('level'=>$this->session->userdata('level')),'',$r['id_mainmenu']); ?>
    </td>
    </tr>
      <tr>
