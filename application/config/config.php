...
|
*/
$allowed_domains = array('reg.siakad.ac.id', 'student.siakad.ac.id');
// $default_domain  = "localhost:8080/siakad.ac.id";
...
// $config['base_url'] = 'http://localhost:8080/sistem-informasi-akademik';
