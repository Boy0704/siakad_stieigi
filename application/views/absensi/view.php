...
$(document).ready(function(){
  ...
  function belumabsen()
  {
      swal('Lakukan Autosave Terlebih dulu', "Absen Mahasiswa tidak dapat disimpan didatabase jika anda belum melakukan auto save terlebih dulu", "warning");
  }
...
<div class="col-md-3">
    <table class="table table-bordered">
        <tr class="alert-info"><th colspan="2">Kelas Anda</th></tr>
        <tr class=""><th colspan="2">Tahun Akademik <?php echo get_tahun_ajaran_aktif('keterangan'); ?></th></tr>
        <td colspan="2">
            <div class="col-md-14">
