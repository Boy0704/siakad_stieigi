...
class Penelitian_model extends CI_Model
{
    ...
    function total_rows($q = NULL) {
        $this->db->like('id_penelitian', $q);
	$this->db->or_like('nidn', $q);
	$this->db->or_like('nama_dosen', $q);
	$this->db->or_like('jenis_penelitian', $q);
	$this->db->or_like('total_dana', $q);
	$this->db->or_like('file_proposal', $q);
...
/* Generated by Harviacode Codeigniter CRUD Generator 2018-08-07 01:35:02 */
/* http://harviacode.com */